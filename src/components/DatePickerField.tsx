...
const styles = StyleSheet.create({
  ...
  closeButton: { alignItems: 'center', backgroundColor: colors.surface, borderColor: colors.border, borderRadius: 14, borderWidth: 1, height: 44, justifyContent: 'center', width: 44 },
  presets: { flexDirection: 'row', gap: spacing.sm, marginTop: spacing.lg },
  presetButton: { alignItems: 'center', backgroundColor: colors.surface, borderColor: colors.border, borderRadius: 12, borderWidth: 1, flex: 1, justifyContent: 'center', minHeight: 44, paddingHorizontal: spacing.sm },
  ...
  monthButton: { alignItems: 'center', backgroundColor: colors.surface, borderColor: colors.border, borderRadius: 12, borderWidth: 1, height: 44, justifyContent: 'center', width: 44 },
  ...
  dayButton: { alignItems: 'center', borderRadius: 22, height: 42, justifyContent: 'center', width: 42 },
